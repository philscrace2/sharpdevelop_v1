...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class PropertiesShouldNotHaveSetOnly : AbstractReflectionRule, IPropertyRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.PropertiesShouldNotHaveSetOnly.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.PropertiesShouldNotHaveSetOnly.Details}";
			}
		}
		...
		public Resolution Check(PropertyInfo property)
		{
			if (!property.CanRead && property.CanWrite) {
				return new Resolution(this, 
				                      "${res:ICSharpCode.AssemblyAnalyser.Rules.PropertiesShouldNotHaveSetOnly.Resolution}",
