...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class EventFirstParameterIsObjectRule : AbstractReflectionRule, IEventRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.EventFirstParameterIsObject.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.EventFirstParameterIsObject.Details}";
			}
		}
		...
		public Resolution Check(EventInfo evnt)
		{
			...
			if (parameters.Length > 0 && parameters[0].ParameterType != typeof(System.Object)) {
				return new Resolution(this, "${res:ICSharpCode.AssemblyAnalyser.Rules.EventFirstParameterIsObject.Resolution}", evnt.EventHandlerType.FullName, new string[,] { { "EventType", evnt.EventHandlerType.FullName }, { "OldParameterType", parameters[0].ParameterType.FullName }});
			}
			return null;
		}
	}
