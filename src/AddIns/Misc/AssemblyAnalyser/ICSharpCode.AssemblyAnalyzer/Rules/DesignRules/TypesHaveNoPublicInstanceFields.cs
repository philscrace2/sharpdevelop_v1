...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class TypesHaveNoPublicInstanceFields : AbstractReflectionRule, IFieldRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.TypesHaveNoPublicInstanceFields.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.TypesHaveNoPublicInstanceFields.Details}";
			}
		}
		...
		public Resolution Check(Module module, FieldInfo field)
		{
			if (!field.IsStatic && (field.IsPublic || field.IsAssembly)) {
				return new Resolution(this, 
				                      "${res:ICSharpCode.AssemblyAnalyser.Rules.TypesHaveNoPublicInstanceFields.Resolution}",
