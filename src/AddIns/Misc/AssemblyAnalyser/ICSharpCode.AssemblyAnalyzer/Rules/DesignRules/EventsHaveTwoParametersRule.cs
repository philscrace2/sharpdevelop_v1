...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class EventsHaveTwoParametersRule : AbstractReflectionRule, IEventRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.EventsHaveTwoParameters.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.EventsHaveTwoParameters.Details}";
			}
		}
		...
		public Resolution Check(EventInfo evnt)
		{
			...
			if (parameters.Length != 2) {
				return new Resolution(this, "${res:ICSharpCode.AssemblyAnalyser.Rules.EventsHaveTwoParameters.Resolution}", evnt.EventHandlerType.FullName, new string[,] { { "EventType", evnt.EventHandlerType.FullName }});
			}
			return null;
		}
	}
