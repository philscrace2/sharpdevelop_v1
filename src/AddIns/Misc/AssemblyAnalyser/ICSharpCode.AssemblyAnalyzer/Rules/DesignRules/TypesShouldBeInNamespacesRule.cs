...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class TypesShouldBeInNamespacesRule : AbstractReflectionRule, ITypeRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.TypesShouldBeInNamespaces.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.TypesShouldBeInNamespaces.Details}";
			}
		}
		...
		public Resolution Check(Type type)
		{
			if (type.Namespace == null || type.Namespace.Length == 0) {
				return new Resolution(this, "${res:ICSharpCode.AssemblyAnalyser.Rules.TypesShouldBeInNamespaces.Resolution}", type.FullName, new string[,] { { "TypeName", type.FullName }});
			}
			return null;
		}
	}
