...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class EventHandlersReturnVoidRule : AbstractReflectionRule, IEventRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.EventHandlersReturnVoid.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.EventHandlersReturnVoid.Details}";
			}
		}
		...
		public Resolution Check(EventInfo evnt)
		{
			...
			if (invokeMethod.ReturnType != typeof(void)) {
				return new Resolution(this, "${res:ICSharpCode.AssemblyAnalyser.Rules.EventHandlersReturnVoid.Resolution}", evnt.EventHandlerType.FullName, new string[,] { { "EventType", evnt.EventHandlerType.FullName }, {"OldReturnType", invokeMethod.ReturnType.FullName}});
			}
			return null;
		}
	}
