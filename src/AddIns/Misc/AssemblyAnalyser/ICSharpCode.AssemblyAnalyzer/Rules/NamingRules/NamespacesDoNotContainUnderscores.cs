...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class NamespacesDoNotContainUnderscores : AbstractReflectionRule, INamespaceRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.NamespacesDoNotContainUnderscores.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.NamespacesDoNotContainUnderscores.Details}";
			}
		}
		...
		public Resolution Check(string namespaceName, ICollection types)
		{
			if (NamingUtilities.ContainsUnderscore(namespaceName)) {
				return new Resolution(this, "${res:ICSharpCode.AssemblyAnalyser.Rules.NamespacesDoNotContainUnderscores.Resolution}", namespaceName, new string[,]{{"NamespaceName", namespaceName}});
			}
			return null;
		}
	}
