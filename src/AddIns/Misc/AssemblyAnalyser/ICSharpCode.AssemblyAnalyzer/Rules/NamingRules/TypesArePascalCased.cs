...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class TypesArePascalCased : AbstractReflectionRule, ITypeRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.TypesArePascalCased.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.TypesArePascalCased.Details}";
			}
		}
		...
		public Resolution Check(Type type)
		{
			if (!NamingUtilities.IsPascalCase(type.Name)) {
				return new Resolution(this, "${res:ICSharpCode.AssemblyAnalyser.Rules.TypesArePascalCased.Resolution}", type.FullName, new string[,] { { "TypeName", type.FullName }, {"AlternateName", NamingUtilities.PascalCase(type.Name)}});
			}
			return null;
		}
	}
