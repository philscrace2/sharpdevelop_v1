...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class MembersArePascalCased : AbstractReflectionRule, IMemberRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.MembersArePascalCased.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.MembersArePascalCased.Details}";
			}
		}
		...
		public Resolution Check(Module module, MemberInfo member)
		{
			...
			if (!NamingUtilities.IsPascalCase(member.Name)) {
				return new Resolution(this, 
				                      "${res:ICSharpCode.AssemblyAnalyser.Rules.MembersArePascalCased.Resolution}",
