...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class EventHandlerSuffixIsEventHandler : AbstractReflectionRule, IEventRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.EventHandlerSuffixIsEventHandler.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.EventHandlerSuffixIsEventHandler.Details}";
			}
		}
		...
		public Resolution Check(EventInfo evnt)
		{
			if (!evnt.EventHandlerType.Name.EndsWith("EventHandler")) {
				return new Resolution(this, "${res:ICSharpCode.AssemblyAnalyser.Rules.EventHandlerSuffixIsEventHandler.Resolution}", evnt.EventHandlerType.FullName, new string[,] { { "EventType", evnt.EventHandlerType.FullName }});
			}
			return null;
		}
	}
