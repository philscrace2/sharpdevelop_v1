...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class DelegatesHaveNoDelegateSuffix : AbstractReflectionRule, ITypeRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.DelegatesHaveNoDelegateSuffix.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.DelegatesHaveNoDelegateSuffix.Details}";
			}
		}
		...
		public Resolution Check(Type type)
		{
			if (type.IsSubclassOf(typeof(System.Delegate)) && type.Name.EndsWith("Delegate")) {
				return new Resolution(this, "${res:ICSharpCode.AssemblyAnalyser.Rules.DelegatesHaveNoDelegateSuffix.Resolution}", type.FullName, new string[,] { { "TypeName", type.FullName }});
			}
			return null;
		}
	}
