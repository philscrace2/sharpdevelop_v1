...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class InterfacesPrefixIsI : AbstractReflectionRule, ITypeRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.InterfacesPrefixIsI.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.InterfacesPrefixIsI.Details}";
			}
		}
		...
		public Resolution Check(Type type)
		{
			if (type.IsInterface && !type.Name.StartsWith("I")) {
				return new Resolution(this, "${res:ICSharpCode.AssemblyAnalyser.Rules.InterfacesPrefixIsI.Resolution}", type.FullName, new string[,] { { "TypeName", type.FullName }});
			}
			return null;
		}
	}
