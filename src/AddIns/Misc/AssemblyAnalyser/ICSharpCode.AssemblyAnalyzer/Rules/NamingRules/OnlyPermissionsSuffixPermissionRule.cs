...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class OnlyPermissionsSuffixPermissionRule : AbstractReflectionRule, ITypeRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.OnlyPermissionsSuffixPermission.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.OnlyPermissionsSuffixPermission.Details}";
			}
		}
		...
		public Resolution Check(Type type)
		{
			if (!typeof(System.Security.IPermission).IsAssignableFrom(type) && type.Name.EndsWith("Permission")) {
				return new Resolution(this, "${res:ICSharpCode.AssemblyAnalyser.Rules.OnlyPermissionsSuffixPermission.Resolution}", type.FullName, new string[,] { { "TypeName", type.FullName }});
			}
			return null;
		}
	}
