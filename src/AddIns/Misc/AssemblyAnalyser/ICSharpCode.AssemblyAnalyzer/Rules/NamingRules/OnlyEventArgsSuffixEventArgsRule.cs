...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class OnlyEventArgsSuffixEventArgsRule : AbstractReflectionRule, ITypeRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.OnlyEventArgsSuffixEventArgs.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.OnlyEventArgsSuffixEventArgs.Details}";
			}
		}
		...
		public Resolution Check(Type type)
		{
			if (!typeof(System.EventArgs).IsAssignableFrom(type) && type.Name.EndsWith("EventArgs")) {
				return new Resolution(this, "${res:ICSharpCode.AssemblyAnalyser.Rules.OnlyEventArgsSuffixEventArgs.Resolution}", type.FullName, new string[,] { { "TypeName", type.FullName }});
			}
			return null;
		}
	}
