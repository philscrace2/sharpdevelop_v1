...
namespace ICSharpCode.AssemblyAnalyser.Rules
{
	...
	public class OnlyAttributesSuffixAttributeRule : AbstractReflectionRule, ITypeRule
	{
		public override string Description {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.OnlyAttributesSuffixAttribute.Description}";
			}
		}
		
		public override string Details {
			get {
				return "${res:ICSharpCode.AssemblyAnalyser.Rules.OnlyAttributesSuffixAttribute.Details}";
			}
		}
		...
		public Resolution Check(Type type)
		{
			if (!type.IsSubclassOf(typeof(System.Attribute)) && type.Name.EndsWith("Attribute")) {
				return new Resolution(this, "${res:ICSharpCode.AssemblyAnalyser.Rules.OnlyAttributesSuffixAttribute.Resolution}", type.FullName, new string[,] { { "TypeName", type.FullName }});
			}
			return null;
		}
	}
