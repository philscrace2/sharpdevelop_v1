...
{	
	...
	{										
		...
		public override string entityName
		{
			get
			{
				...
				return stringParserService.Parse("${res:SharpQuery.Label.DataBasesRoot}");
			}
		}
		
		public SharpQueryNodeDatabaseRoot() : base( null )
		{																
		...
		{						
			...
			{			
				...
				{										
					...
					if ( SharpQueryTree.SchemaClassDict.Contains( connection.GetType().FullName ) == true )
					{
	...
	{			
		...
		public SharpQueryNodeConnection( IConnection dataConnection ) : base( null )
		{								
	...
	{						
		...
		public SharpQueryNodeTableRoot( AbstractSharpQuerySchemaClass databaseclass) : base( databaseclass )
		{	
			this.ImageIndex = 3;
	...
	{					
		...
		public SharpQueryNodeViewRoot( AbstractSharpQuerySchemaClass databaseclass) : base( databaseclass )
		{	
			this.ImageIndex = 4;
	...
	{							
		...
		public SharpQueryNodeProcedureRoot( AbstractSharpQuerySchemaClass databaseclass) : base( databaseclass )
		{	
			this.ImageIndex = 5;
