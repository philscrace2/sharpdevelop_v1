...
namespace ICSharpCode.SharpDevelop.FormDesigner.Services
{
	class MenuCommandService : IMenuCommandService
	{
		...
		DesignPanel   panel;
		string        alternateContextMenuPath = null;

		public string AlternateContextMenuPath
		{
			get {
				return alternateContextMenuPath;
			}
			set {
				alternateContextMenuPath = value;
			}
		}
...
//			}
		...
		{
			string contextMenuPath = alternateContextMenuPath == null ? "/SharpDevelop/FormsDesigner/ContextMenus/" : alternateContextMenuPath;
