...
namespace WeifenLuo.WinFormsUI
{
	...
	internal class ResourceHelper
	{
		...
		{
			m_resourceManager = new ResourceManager("WinFormsUI.WeifenLuo.WinFormsUI.Strings", typeof(DockPanel).Assembly);
		}
	
		public static Bitmap LoadBitmap(string name)
		{
			Assembly assembly = typeof(ResourceHelper).Assembly;
			string fullNamePrefix = "WinFormsUI.WeifenLuo.WinFormsUI.Resources.";
